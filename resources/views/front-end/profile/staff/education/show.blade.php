                ...
                <div class="col-md-12">
                    ...
                    <div class="job-filter mb-4 d-sm-flex align-items-center">
                        <div class="job-shortby ms-sm-auto d-flex align-items-center">
                            <div class="filter-btn ms-sm-3" style="width:100%"> <a href="{{url('staff/education/create')}}" class="btn btn-outline-primary ans-add-new-btn" style="width:100%">Add Educational History</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        @foreach($staffEdcuation as $education)
                        <div class="col-md-6 col-lg-4">
                            <div class="job-list job-grid pt-3">
                                <div class="job-list-details pb-0 mb-0">
                                    <div class="job-list-info">
                                        <div class="job-list-title">
                                            <h5 class="mb-0"><a href="">{{$education->institutionName}}</a></h5>
                                        </div>
                                        <div class="ans-flex-between">
                                            ...
                                            <div>
                                                <p class="ans-course-duration">{{$education->startDate}}</p>
                                            </div>
                                        </div>
                                        <div>
                                            <p class="ans-institution-name">Institution: {{$education->institutionName}}</p>
                                            <p class="ans-institution-name">From: {{$education->institutionCountry}}{{$education->institutionCity}}</p>
                                            <p class="ans-institution-name">Speciality: {{$education->speciality}}</p>
                                        </div>
                                    </div>
                                </div>
