                            ...
                            <div class="row">
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="31" type="text" class="inputText entertxtOnly" name="emp_title">
                                        <span class="floating-label">Job Title</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="31" type="text" class="inputText entertxtOnly" name="emp_com_name">
                                        <span class="floating-label">Company Name</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input type="date" class="inputText" name="emp_join">
                                        <span class="floating-label">Select Joining Date</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input type="date" class="inputText" name="emp_ending">
                                        <span class="floating-label">Select Ending Date</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="31" type="text" class="inputText entertxtOnly" name="emp_reason">
                                        <span class="floating-label">Reason of leaving</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="31" type="text" class="inputText EnterOnlyNumber" name="emp_postal">
                                        <span class="floating-label">Zip Code/Postal Code</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="101" type="text" class="inputText" name="emp_comp_address">
                                        <span class="floating-label">Company Address</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="31" type="text" class="inputText entertxtOnly" name="emp_contact_name">
                                        <span class="floating-label">Contact Person Name</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-12">
                                    <div class="user-input-wrp">
                                        <input maxlength="31" type="text" class="inputText EnterOnlyNumber" name="phone_number">
    ...
    <script>
        $(document).ready(function (){
            ...
            $('#form').on('submit', function (e) {
                ...
                let route = "{{route('employment-history.store')}}";
                console.log(route)
                $.ajax({
                    type: 'POST',
                    url: route,
